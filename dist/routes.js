...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const account_controller_1 = require("./components/account/account.controller");
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
const models = {
    "ILoginReq": {
        "dataType": "refObject",
...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.post('/account/login', ...((0, runtime_1.fetchMiddlewares)(account_controller_1.AccountController)), ...((0, runtime_1.fetchMiddlewares)(account_controller_1.AccountController.prototype.checkLogin)), function AccountController_checkLogin(request, response, next) {
        const args = {
            data: { "in": "body", "name": "data", "required": true, "ref": "ILoginReq" },
        };
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
            ...
            const promise = controller.checkLogin.apply(controller, validatedArgs);
