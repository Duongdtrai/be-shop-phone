...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/account/login',
            ...
            ...(fetchMiddlewares<RequestHandler>(AccountController.prototype.checkLogin)),

            function AccountController_checkLogin(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.checkLogin.apply(controller, validatedArgs as any);
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/account/login/list',
            ...(fetchMiddlewares<RequestHandler>(AccountController)),
            ...(fetchMiddlewares<RequestHandler>(AccountController.prototype.fetch)),

            function AccountController_fetch(request: any, response: any, next: any) {
            const args = {
                    data: {"in":"body","name":"data","required":true,"ref":"ILoginReq"},
            };
